...
Plantilla.listadoNombresOrdenados = function (vector) {
    ...
    listaNombres.forEach((e) => { msj += Plantilla.plantillaTablaPersonas.actualizaNombres(e) })
  
    msj += Plantilla.plantillaTablaPersonas.pie;
    Frontend.Article.actualizar("Lista con únicamente el nombre de los corredores ordenados", msj )
